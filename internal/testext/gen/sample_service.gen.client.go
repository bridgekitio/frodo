...
func (client *sampleServiceClient) Chain1(ctx context.Context, request *testext.SampleRequest) (*testext.SampleResponse, error) {
	...
	response := &testext.SampleResponse{}
	err := client.Invoke(ctx, "POST", "/v2/SampleService.Chain1", request, response)
	return response, err
...
func (client *sampleServiceClient) Chain1GroupFooBar(ctx context.Context, request *testext.SampleRequest) (*testext.SampleResponse, error) {
	...
	response := &testext.SampleResponse{}
	err := client.Invoke(ctx, "POST", "/v2/SampleService.Chain1GroupFooBar", request, response)
	return response, err
...
// react to this event.
func (client *sampleServiceClient) Chain1GroupStar(ctx context.Context, request *testext.SampleRequest) (*testext.SampleResponse, error) {
	...
	response := &testext.SampleResponse{}
	err := client.Invoke(ctx, "POST", "/v2/SampleService.Chain1GroupStar", request, response)
	return response, err

}

// Chain2 ALWAYS FAILS, SO CHAIN3 NEVER FIRES!!!
func (client *sampleServiceClient) Chain2(ctx context.Context, request *testext.SampleRequest) (*testext.SampleResponse, error) {
	...
	response := &testext.SampleResponse{}
	err := client.Invoke(ctx, "POST", "/v2/SampleService.Chain2", request, response)
	return response, err

}

// Chain2OnError listens for errors that occur on calls to Chain2
func (client *sampleServiceClient) Chain2OnError(ctx context.Context, request *testext.FailAlwaysErrorRequest) (*testext.FailAlwaysErrorResponse, error) {

	// Not exposed, so don't bother with a round trip to the server just to get a "not found" error anyway.
	return nil, fail.NotImplemented("Chain2OnError is not supported in the API gateway")
...
func (client *sampleServiceClient) Chain2OnSuccess(ctx context.Context, request *testext.SampleRequest) (*testext.SampleResponse, error) {

	// Not exposed, so don't bother with a round trip to the server just to get a "not found" error anyway.
	return nil, fail.NotImplemented("Chain2OnSuccess is not supported in the API gateway")
...
func (client *sampleServiceClient) SecureWithRolesAliased(ctx context.Context, request *testext.SampleSecurityRequest) (*testext.SampleSecurityResponse, error) {
	...
	response := &testext.SampleSecurityResponse{}
	err := client.Invoke(ctx, "POST", "/v2/SampleService.SecureWithRolesAliased", request, response)
	return response, err
