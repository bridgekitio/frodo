...
class SampleServiceClient {
  ...
  Future<SampleResponse> Chain1GroupFooBar(SampleRequest serviceRequest, {String authorization = ''}) async {
  
    var requestJson = serviceRequest.toJson();
    var method = 'POST';
    var route = '/v2/SampleService.Chain1GroupFooBar';
    var uri = _joinUrl([baseURL, _buildRequestPath(method, route, requestJson)]);
  ...
  /// react to this event.
  Future<SampleResponse> Chain1GroupStar(SampleRequest serviceRequest, {String authorization = ''}) async {
  
    var requestJson = serviceRequest.toJson();
    var method = 'POST';
    var route = '/v2/SampleService.Chain1GroupStar';
    var uri = _joinUrl([baseURL, _buildRequestPath(method, route, requestJson)]);
